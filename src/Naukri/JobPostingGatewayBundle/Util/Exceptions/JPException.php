<?php
namespace Naukri\JobPostingGatewayBundle\Util\Exceptions;

use Naukri\JobPostingGatewayBundle\Resources\model\JPMessages;

use Naukri\JobPostingGatewayBundle\Util\ResourceUtil;
...
class JPException extends Exception
{
    ...
    public function __construct($message = null, $code = null) { 
        ...
        if (empty($message)) {
            if (!is_null($code)) {
                $message = JPMessages::getMessage($code);
            }
        }
