<?php
namespace Naukri\JobPostingGatewayBundle\DependencyInjection\Overrides;
 ...
 * @author prabin
 */
class JPSmartyEngine extends SmartyEngine
{
        ...
        try
        {
            ...
            foreach ($classes["register.classes"] as $name=>$path)
            {
                try
                {
                    ...
                    //$container->get("jp.logger")->getLogger()->err("error while registering php class to smarty ". $e->getMessage());
                }
            }
        }
        catch (Exception $e) {
