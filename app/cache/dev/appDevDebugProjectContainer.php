...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'account.dao' => 'getAccount_DaoService',
            'account.service' => 'getAccount_ServiceService',
            ...
            'filestorage.util' => 'getFilestorage_UtilService',
            ...
            'jp.auth.util' => 'getJp_Auth_UtilService',
            'jp.log.formatter' => 'getJp_Log_FormatterService',
            'jp.log.processor' => 'getJp_Log_ProcessorService',
            'jp.logger' => 'getJp_LoggerService',
            'jp.session.handler' => 'getJp_Session_HandlerService',
            'jp.sql.log.handler' => 'getJp_Sql_Log_HandlerService',
            'jpcentral.logger' => 'getJpcentral_LoggerService',
            'jpsso.security.authentication.listener' => 'getJpsso_Security_Authentication_ListenerService',
            'jpsso.security.authentication.provider' => 'getJpsso_Security_Authentication_ProviderService',
            'jpsso.security.user.provider' => 'getJpsso_Security_User_ProviderService',
            'json.parser.service' => 'getJson_Parser_ServiceService',
            ...
            'monolog.handler.filestream' => 'getMonolog_Handler_FilestreamService',
            ...
            'monolog.handler.jp' => 'getMonolog_Handler_JpService',
            'monolog.handler.main' => 'getMonolog_Handler_MainService',
            'monolog.handler.null_internal' => 'getMonolog_Handler_NullInternalService',
            'monolog.logger.assetic' => 'getMonolog_Logger_AsseticService',
            'monolog.logger.doctrine' => 'getMonolog_Logger_DoctrineService',
            'monolog.logger.event' => 'getMonolog_Logger_EventService',
            'monolog.logger.jp' => 'getMonolog_Logger_JpService',
            'monolog.logger.php' => 'getMonolog_Logger_PhpService',
            'monolog.logger.profiler' => 'getMonolog_Logger_ProfilerService',
            'monolog.logger.request' => 'getMonolog_Logger_RequestService',
            'monolog.logger.security' => 'getMonolog_Logger_SecurityService',
            'monolog.logger.smartybundle' => 'getMonolog_Logger_SmartybundleService',
            'monolog.logger.templating' => 'getMonolog_Logger_TemplatingService',
            'monolog.logger.translation' => 'getMonolog_Logger_TranslationService',
            'monolog.processor.psr_log_message' => 'getMonolog_Processor_PsrLogMessageService',
            'pest.util' => 'getPest_UtilService',
            ...
            'security.authentication.listener.jpsso.jp_sso' => 'getSecurity_Authentication_Listener_Jpsso_JpSsoService',
            'security.authentication.manager' => 'getSecurity_Authentication_ManagerService',
            'security.authentication.provider.jpsso.jp_sso' => 'getSecurity_Authentication_Provider_Jpsso_JpSsoService',
            ...
            'security.firewall.map.context.jp_insta' => 'getSecurity_Firewall_Map_Context_JpInstaService',
            'security.firewall.map.context.jp_open_api' => 'getSecurity_Firewall_Map_Context_JpOpenApiService',
            'security.firewall.map.context.jp_ops_interface' => 'getSecurity_Firewall_Map_Context_JpOpsInterfaceService',
            'security.firewall.map.context.jp_sso' => 'getSecurity_Firewall_Map_Context_JpSsoService',
            ...
            'security.user_checker.jp_sso' => 'getSecurity_UserChecker_JpSsoService',
            ...
            'smarty' => 'getSmartyService',
            'smarty.extension.assetic.dynamic' => 'getSmarty_Extension_Assetic_DynamicService',
            'smarty.extension.routing' => 'getSmarty_Extension_RoutingService',
            'smarty.templating.finder' => 'getSmarty_Templating_FinderService',
            ...
            'templating.engine.smarty' => 'getTemplating_Engine_SmartyService',
            ...
            'utbundle.smarty.extension.assets' => 'getUtbundle_Smarty_Extension_AssetsService',
            'utbundle.smarty.extension.custom.render' => 'getUtbundle_Smarty_Extension_Custom_RenderService',
        ...
        $this->aliases = array(
            ...
            'monolog.handler.sqlhandle' => 'jp.sql.log.handler',
            'security.user_checker.secured_area' => 'security.user_checker.jp_sso',
            'sensio.distribution.webconfigurator' => 'sensio_distribution.webconfigurator',
            'session.handler' => 'jp.session.handler',
            'session.storage' => 'session.storage.native',
            'smarty.engine' => 'templating.engine.smarty',
            'smarty_engine' => 'templating.engine.smarty',
    ...
    /**
     * Gets the public 'account.dao' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Dao\ncPDO\AccountDao
     */
    protected function getAccount_DaoService()
    {
        return $this->services['account.dao'] = new \Naukri\JobPostingGatewayBundle\Dao\ncPDO\AccountDao();
    }

    /**
     * Gets the public 'account.service' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Service\AccountService
     */
    protected function getAccount_ServiceService()
    {
        $this->services['account.service'] = $instance = new \Naukri\JobPostingGatewayBundle\Service\AccountService();

        $instance->accountDao = $this->get('account.dao');
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($a, array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), $c, true), 'php' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Symfony\Bundle\AsseticBundle\Factory\Loader\AsseticHelperFormulaLoader($a), $c, true), 'smarty' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \NoiseLabs\Bundle\SmartyBundle\Assetic\SmartyFormulaLoader($this->get('templating.engine.smarty')), $c, true)));
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', ($this->targetDirs[2].'/Resources/views'), '/\\.[^.]+\\.smarty$/'), 'smarty');
    ...
    {
        return $this->services['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('v13', '%2$s/%1$s');
    }
    ...
    {
        return $this->services['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\UrlPackage(array(0 => 'https://test1.static.infoedge.com', 1 => 'https://test1.login.recruit.infoedge.com/rStaticSecure'), $this->get('assets._version__default'), $this->get('assets.context')), array());
    }
     ...
     *
     * @return \EntityManager5ca108e798ecc_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once (__DIR__.'/jms_diextra/doctrine/EntityManager_5ca108e798ecc.php');

        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5ca108e798ecc_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($this->get('doctrine.orm.default_entity_manager.delegate'), $this);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_109a2bc9f9623ddf451bc54589d0458d36e56f86f35751c5b248df1ee689e3b6');
    ...
    /**
     * Gets the public 'filestorage.util' shared service.
     *
     * @return \Naukri\UtilityBundle\Util\FileStorage\FileStorageUtil
     */
    protected function getFilestorage_UtilService()
    {
        return $this->services['filestorage.util'] = new \Naukri\UtilityBundle\Util\FileStorage\FileStorageUtil();
    }
     ...
     *
     * @return \JMS\DiExtraBundle\Metadata\Driver\ConfiguredControllerInjectionsDriver
     */
    protected function getJmsDiExtra_MetadataDriverService()
    {
        return $this->services['jms_di_extra.metadata_driver'] = new \JMS\DiExtraBundle\Metadata\Driver\ConfiguredControllerInjectionsDriver(new \JMS\DiExtraBundle\Metadata\Driver\AnnotationDriver($this->get('annotation_reader'), $this->get('jms_di_extra.service_naming_strategy')), array('container' => new \Symfony\Component\DependencyInjection\Reference('service_container'), 'authenticationUtil' => new \Symfony\Component\DependencyInjection\Reference('jp.auth.util'), 'logger' => new \Symfony\Component\DependencyInjection\Reference('jp.logger'), 'clientUtil' => new \Symfony\Component\DependencyInjection\Reference('client.util')), array());
    }
    ...
    /**
     * Gets the public 'jp.auth.util' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Auth\AuthenticationUtil
     */
    protected function getJp_Auth_UtilService()
    {
        $this->services['jp.auth.util'] = $instance = new \Naukri\JobPostingGatewayBundle\Util\Auth\AuthenticationUtil();
    ...
    /**
     * Gets the public 'jp.log.formatter' shared service.
     *
     * @return \Monolog\Formatter\LineFormatter
     */
    protected function getJp_Log_FormatterService()
    {
        return $this->services['jp.log.formatter'] = new \Monolog\Formatter\LineFormatter('[%datetime%] [%channel%.%level_name%]: [%extra.token%] [%extra.class%]:[%extra.function%] in line %extra.line%: %message% %context%'."\n".'');
    }

    /**
     * Gets the public 'jp.log.processor' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Logger\LogProcessor
     */
    protected function getJp_Log_ProcessorService()
    {
        $this->services['jp.log.processor'] = $instance = new \Naukri\JobPostingGatewayBundle\Util\Logger\LogProcessor();
    ...
    /**
     * Gets the public 'jp.logger' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Logger\JPLogger
     */
    protected function getJp_LoggerService()
    {
        return $this->services['jp.logger'] = new \Naukri\JobPostingGatewayBundle\Util\Logger\JPLogger($this->get('monolog.logger.jp'));
    }

    /**
     * Gets the public 'jp.session.handler' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Auth\JPSessionHandler
     */
    protected function getJp_Session_HandlerService()
    {
        return $this->services['jp.session.handler'] = new \Naukri\JobPostingGatewayBundle\Util\Auth\JPSessionHandler(array('db_table' => 'SESSION_DATA', 'db_id_col' => 'id', 'db_data_col' => 'data', 'db_time_col' => 'TIME_STAMP'));
    }

    /**
     * Gets the public 'jp.sql.log.handler' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Logger\SQLHandler
     */
    protected function getJp_Sql_Log_HandlerService()
    {
        return $this->services['jp.sql.log.handler'] = new \Naukri\JobPostingGatewayBundle\Util\Logger\SQLHandler(array('level' => 'debug', 'email' => 'abc@gmail.com'));
    }

    /**
     * Gets the public 'jpcentral.logger' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Logger\JPCentralLogger
     */
    protected function getJpcentral_LoggerService()
    {
        return $this->services['jpcentral.logger'] = new \Naukri\JobPostingGatewayBundle\Util\Logger\JPCentralLogger();
    }

    /**
     * Gets the public 'jpsso.security.authentication.listener' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Auth\JPSSOAuthListener
     */
    protected function getJpsso_Security_Authentication_ListenerService()
    {
        return $this->services['jpsso.security.authentication.listener'] = new \Naukri\JobPostingGatewayBundle\Util\Auth\JPSSOAuthListener($this->get('security.context'), $this->get('security.authentication.manager'), $this->get('templating'));
    }

    /**
     * Gets the public 'jpsso.security.authentication.provider' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Auth\JPSSOProvider
     */
    protected function getJpsso_Security_Authentication_ProviderService()
    {
        return $this->services['jpsso.security.authentication.provider'] = new \Naukri\JobPostingGatewayBundle\Util\Auth\JPSSOProvider($this->get('jpsso.security.user.provider'));
    }

    /**
     * Gets the public 'jpsso.security.user.provider' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Auth\JPSSOUserProvider
     */
    protected function getJpsso_Security_User_ProviderService()
    {
        return $this->services['jpsso.security.user.provider'] = new \Naukri\JobPostingGatewayBundle\Util\Auth\JPSSOUserProvider();
    }

    /**
     * Gets the public 'json.parser.service' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Common\JsonParser
     */
    protected function getJson_Parser_ServiceService()
    {
        return $this->services['json.parser.service'] = new \Naukri\JobPostingGatewayBundle\Util\Common\JsonParser();
    }
    ...
    /**
     * Gets the public 'monolog.handler.filestream' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected function getMonolog_Handler_FilestreamService()
    {
        $this->services['monolog.handler.filestream'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/logs/dev.log'), 200, true, NULL);

        $instance->pushProcessor($this->get('monolog.processor.psr_log_message'));
        $instance->setFormatter($this->get('jp.log.formatter'));
    ...
    /**
     * Gets the public 'monolog.handler.grouped' shared service.
     *
     * @return \Monolog\Handler\GroupHandler
     */
    protected function getMonolog_Handler_GroupedService()
    {
        $this->services['monolog.handler.grouped'] = $instance = new \Monolog\Handler\GroupHandler(array(0 => $this->get('monolog.handler.filestream'), 1 => $this->get('jp.sql.log.handler')), true);
    ...
    /**
     * Gets the public 'monolog.handler.jp' shared service.
     *
     * @return \Monolog\Handler\FingersCrossedHandler
     */
    protected function getMonolog_Handler_JpService()
    {
        $this->services['monolog.handler.jp'] = $instance = new \Monolog\Handler\FingersCrossedHandler($this->get('monolog.handler.grouped'), 200, 0, true, true, NULL);
    ...
    /**
     * Gets the public 'monolog.logger.jp' shared service.
     *
     * @return \Symfony\Bridge\Monolog\Logger
     */
    protected function getMonolog_Logger_JpService()
    {
        $this->services['monolog.logger.jp'] = $instance = new \Symfony\Bridge\Monolog\Logger('jp');

        $instance->pushHandler($this->get('monolog.handler.jp'));
        $instance->pushHandler($this->get('monolog.handler.debug'));
        $instance->pushProcessor(array(0 => $this->get('jp.log.processor'), 1 => 'processLogRecord'));
    ...
    /**
     * Gets the public 'monolog.logger.smartybundle' shared service.
     *
     * @return \Symfony\Bridge\Monolog\Logger
     */
    ...
    /**
     * Gets the public 'pest.util' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Pest\PestUtil
     */
    protected function getPest_UtilService()
    {
        $this->services['pest.util'] = $instance = new \Naukri\JobPostingGatewayBundle\Util\Pest\PestUtil();

        $instance->jsonParser = $this->get('json.parser.service');
    ...
    /**
     * Gets the public 'security.authentication.listener.jpsso.jp_sso' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Auth\JPSSOAuthListener
     */
    protected function getSecurity_Authentication_Listener_Jpsso_JpSsoService()
    {
        return $this->services['security.authentication.listener.jpsso.jp_sso'] = new \Naukri\JobPostingGatewayBundle\Util\Auth\JPSSOAuthListener($this->get('security.context'), $this->get('security.authentication.manager'), $this->get('templating'));
    }

    /**
     * Gets the public 'security.authentication.provider.jpsso.jp_sso' shared service.
     *
     * @return \Naukri\JobPostingGatewayBundle\Util\Auth\JPSSOProvider
     */
    protected function getSecurity_Authentication_Provider_Jpsso_JpSsoService()
    {
        return $this->services['security.authentication.provider.jpsso.jp_sso'] = new \Naukri\JobPostingGatewayBundle\Util\Auth\JPSSOProvider($this->get('jpsso.security.user.provider'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.jp_open_api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/resource/openApi'), 'security.firewall.map.context.jp_ops_interface' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/operations'), 'security.firewall.map.context.jp_insta' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/hiring/instajob'), 'security.firewall.map.context.jp_sso' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    /**
     * Gets the public 'security.firewall.map.context.jp_insta' shared service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext
     */
    protected function getSecurity_Firewall_Map_Context_JpInstaService()
    {
        return $this->services['security.firewall.map.context.jp_insta'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }

    /**
     * Gets the public 'security.firewall.map.context.jp_open_api' shared service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext
     */
    protected function getSecurity_Firewall_Map_Context_JpOpenApiService()
    {
        return $this->services['security.firewall.map.context.jp_open_api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }

    /**
     * Gets the public 'security.firewall.map.context.jp_ops_interface' shared service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext
     */
    protected function getSecurity_Firewall_Map_Context_JpOpsInterfaceService()
    {
        return $this->services['security.firewall.map.context.jp_ops_interface'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }

    /**
     * Gets the public 'security.firewall.map.context.jp_sso' shared service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext
     */
    protected function getSecurity_Firewall_Map_Context_JpSsoService()
    {
        $a = $this->get('security.token_storage');
        $b = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        return $this->services['security.firewall.map.context.jp_sso'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('jpsso.security.user.provider')), 'jp_sso', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => $this->get('security.authentication.listener.jpsso.jp_sso'), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'jp_sso', NULL, NULL, NULL, $b, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $f = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        ...
        $g->setOptions(array('login_path' => '/demo/secured/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $h->setOptions(array('login_path' => '/demo/secured/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('jpsso.security.user.provider')), 'secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $g, $h, array('check_path' => '/demo/secured/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/demo/secured/login', false), NULL, NULL, $b, false));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_MANAGER', 1 => 'ROLE_RECRUITER', 2 => 'ROLE_MANAGE_WORKFLOW', 3 => 'ROLE_MANAGE_RECRUITERS', 4 => 'ROLE_MANAGE_SETTINGS', 5 => 'ROLE_DOWNLOAD')));
    }
    ...
    /**
     * Gets the public 'security.user_checker.jp_sso' shared service.
     *
     * @return \Symfony\Component\Security\Core\User\UserChecker
     */
    protected function getSecurity_UserChecker_JpSsoService()
    {
        return $this->services['security.user_checker.jp_sso'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('name' => 'JP_SESSION', 'cookie_lifetime' => 31536000, 'cookie_httponly' => true, 'gc_probability' => 1), $this->get('jp.session.handler'), $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['session.storage.php_bridge'] = new \Symfony\Component\HttpFoundation\Session\Storage\PhpBridgeSessionStorage($this->get('jp.session.handler'), $this->get('session.storage.metadata_bag'));
    }
    ...
    /**
     * Gets the public 'smarty' shared service.
     *
     * @return \Smarty
     */
    protected function getSmartyService()
    {
        return $this->services['smarty'] = new \Smarty();
    }

    /**
     * Gets the public 'smarty.extension.assetic.dynamic' shared service.
     *
     * @return \NoiseLabs\Bundle\SmartyBundle\Extension\DynamicAsseticExtension
     */
    protected function getSmarty_Extension_Assetic_DynamicService()
    {
        return $this->services['smarty.extension.assetic.dynamic'] = new \NoiseLabs\Bundle\SmartyBundle\Extension\DynamicAsseticExtension($this->get('smarty.extension.routing'), $this->get('assetic.asset_factory'), true, $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }

    /**
     * Gets the public 'smarty.templating.finder' shared service.
     *
     * @return \NoiseLabs\Bundle\SmartyBundle\CacheWarmer\SmartyTemplateFinder
     */
    protected function getSmarty_Templating_FinderService()
    {
        return $this->services['smarty.templating.finder'] = new \NoiseLabs\Bundle\SmartyBundle\CacheWarmer\SmartyTemplateFinder($this->get('kernel'), $this->get('templating.filename_parser'), ($this->targetDirs[2].'/Resources'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('172.10.122.27:25');
        $instance->setPort(25);
    ...
    /**
     * Gets the public 'templating.engine.smarty' shared service.
     *
     * @return \Naukri\UtilityBundle\DependencyInjection\Overrides\NaukriSmartyEngine
     */
    protected function getTemplating_Engine_SmartyService()
    {
        $this->services['templating.engine.smarty'] = $instance = new \Naukri\UtilityBundle\DependencyInjection\Overrides\NaukriSmartyEngine($this->get('smarty'), $this, $this->get('templating.name_parser'), $this->get('templating.loader'), array('escape_html' => true, 'error_reporting' => 'error_reporting() & ~E_NOTICE', 'left_delimiter' => '~', 'right_delimiter' => '`', 'cache_dir' => (__DIR__.'/smarty/cache'), 'compile_dir' => (__DIR__.'/smarty/templates_c'), 'config_dir' => ($this->targetDirs[2].'/config/smarty'), 'default_resource_type' => 'file', 'plugins_dir' => array(), 'template_dir' => ($this->targetDirs[2].'/Resources/views'), 'use_include_path' => false, 'use_sub_dirs' => true), $this->get('templating.globals', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.smartybundle', ContainerInterface::NULL_ON_INVALID_REFERENCE));
        ...
        $instance->addExtension($this->get('smarty.extension.routing'));
        $instance->addExtension(new \NoiseLabs\Bundle\SmartyBundle\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \NoiseLabs\Bundle\SmartyBundle\Extension\SecurityExtension($this->get('security.context', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        $instance->addExtension(new \NoiseLabs\Bundle\SmartyBundle\Extension\ExpressionExtension());
        $instance->addExtension($this->get('smarty.extension.assetic.dynamic'));
        $instance->addExtension(new \NoiseLabs\Bundle\SmartyBundle\Extension\FormExtension(new \NoiseLabs\Bundle\SmartyBundle\Form\SmartyRenderer(new \NoiseLabs\Bundle\SmartyBundle\Form\SmartyRendererEngine(array(0 => 'form_div_layout.html.tpl')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension($this->get('utbundle.smarty.extension.custom.render'));
        $instance->addExtension($this->get('utbundle.smarty.extension.assets'));
        $instance->addGlobal('NC_IMG_PATH', 'http://dev2.static.infoedge.com/s/4/100/i');
        $instance->addGlobal('AC_IMG_PATH', 'http://dev2.static.infoedge.com/s/4/113_v5.0.0/src/i');
        $instance->addGlobal('NC_CSS_PATH', 'http://dev2.static.infoedge.com/s/4/100/c');
        $instance->addGlobal('AC_CSS_PATH', 'http://dev2.static.infoedge.com/s/4/113_v5.0.0/src/c');
        $instance->addGlobal('NC_JS_PATH', 'http://dev2.static.infoedge.com/s/4/100/j');
        $instance->addGlobal('AC_JS_PATH', 'http://dev2.static.infoedge.com/s/4/113_v5.0.0/src/j');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($this->get('twig.loader'), array('exception_controller' => 'NaukriUtilityBundle:NaukriException:show', 'debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    {
        return $this->services['twig.controller.preview_error'] = new \Symfony\Bundle\TwigBundle\Controller\PreviewErrorController($this->get('http_kernel'), 'NaukriUtilityBundle:NaukriException:show');
    }
    ...
    {
        return $this->services['twig.exception_listener'] = new \Symfony\Component\HttpKernel\EventListener\ExceptionListener('NaukriUtilityBundle:NaukriException:show', $this->get('monolog.logger.request', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/noiselabs/smarty-bundle/NoiseLabs/Bundle/SmartyBundle/Resources/views'), 'Smarty');
        $instance->addPath(($this->targetDirs[3].'/src/Naukri/JobPostingGatewayBundle/Resources/views'), 'NaukriJobPostingGateway');
        $instance->addPath(($this->targetDirs[3].'/src/Naukri/UtilityBundle/Resources/views'), 'NaukriUtility');
        $instance->addPath(($this->targetDirs[3].'/vendor/externals/recruiterGnb/ComponentBundle/Resources/views'), 'NaukriComponent');
    ...
    /**
     * Gets the public 'utbundle.smarty.extension.assets' shared service.
     *
     * @return \Naukri\UtilityBundle\UtilSmartyExtension\NaukriAssetsExtension
     */
    protected function getUtbundle_Smarty_Extension_AssetsService()
    {
        return $this->services['utbundle.smarty.extension.assets'] = new \Naukri\UtilityBundle\UtilSmartyExtension\NaukriAssetsExtension($this);
    }

    /**
     * Gets the public 'utbundle.smarty.extension.custom.render' shared service.
     *
     * @return \Naukri\UtilityBundle\UtilSmartyExtension\CustomRenderExtension
     */
    protected function getUtbundle_Smarty_Extension_Custom_RenderService()
    {
        return $this->services['utbundle.smarty.extension.custom.render'] = new \Naukri\UtilityBundle\UtilSmartyExtension\CustomRenderExtension($this);
    }
    ...
    /**
     * Gets the private 'assetic.value_supplier.default' shared service.
     *
     * @return \Symfony\Bundle\AsseticBundle\DefaultValueSupplier
     */
    ...
    protected function getDoctrine_Orm_DefaultEntityManager_DelegateService($lazyLoad = true)
    {
        ...
        $this->services['doctrine.orm.default_entity_manager.delegate'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.default_connection'), $a);
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => $this->get('security.authentication.provider.jpsso.jp_sso'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('jpsso.security.user.provider'), $this->get('security.user_checker.jp_sso'), 'secured_area', $this->get('security.encoder_factory'), true)), true);
    ...
    /**
     * Gets the private 'smarty.extension.routing' shared service.
     *
     * @return \NoiseLabs\Bundle\SmartyBundle\Extension\RoutingExtension
     */
    protected function getSmarty_Extension_RoutingService()
    {
        return $this->services['smarty.extension.routing'] = new \NoiseLabs\Bundle\SmartyBundle\Extension\RoutingExtension($this->get('router'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NaukriJobPostingGatewayBundle' => 'Naukri\\JobPostingGatewayBundle\\NaukriJobPostingGatewayBundle',
                'NaukriUtilityBundle' => 'Naukri\\UtilityBundle\\NaukriUtilityBundle',
                'NaukriComponentBundle' => 'Naukri\\ComponentBundle\\NaukriComponentBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'SmartyBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/noiselabs/smarty-bundle/NoiseLabs/Bundle/SmartyBundle'),
                ...
                'NaukriJobPostingGatewayBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Naukri/JobPostingGatewayBundle'),
                    'namespace' => 'Naukri\\JobPostingGatewayBundle',
                ),
                'NaukriUtilityBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Naukri/UtilityBundle'),
                    'namespace' => 'Naukri\\UtilityBundle',
                ),
                'NaukriComponentBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/externals/recruiterGnb/ComponentBundle'),
                    'namespace' => 'Naukri\\ComponentBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'mailer_host' => '172.10.122.27:25',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'asset.version' => array(
                'script.version' => array(
                    'naukri_jquery' => array(
                        'name' => 'jquery.js',
                        'type' => 'NC0',
                    ),
                    'naukri_require' => array(
                        'name' => 'require.js',
                        'type' => 'NC0',
                    ),
                    'jp_app' => array(
                    ...
                    'vendor_app' => array(
                        'name' => 'common_ore_app.js',
                        'type' => 'AC',
                    ),
                    'ore_reports_app_js' => array(
                        'name' => 'ore_reports_app.js',
                        'type' => 'RPC',
                    ),
                    'common_ore_reports_app_js' => array(
                        'name' => 'common_ore_reports_app.js',
                        'type' => 'RPC',
                    ),
                ),
                'css.version' => array(
                    ...
                    'ore_reports_app_css' => array(
                        'name' => 'ore_reports_app.css',
                        'type' => 'RPC',
                    ),
                ),
            ),
            ...
            'relaxedreplace' => array(
                0 => '&lt;',
                1 => '&gt;',
            ),
            'performstrictreplace' => array(
                'toBeReplaced' => array(
                    0 => '<',
                    1 => '>',
                    2 => '"',
            ...
            'session.db_options' => array(
                'db_table' => 'SESSION_DATA',
                'db_id_col' => 'id',
                'db_data_col' => 'data',
                'db_time_col' => 'TIME_STAMP',
            ),
            'nc_img_path' => 'http://dev2.static.infoedge.com/s/4/100/i',
            'nc_css_path' => 'http://dev2.static.infoedge.com/s/4/100/c',
            'nc_js_path' => 'http://dev2.static.infoedge.com/s/4/100/j',
            'ac_img_path' => 'http://dev2.static.infoedge.com/s/4/113_v5.0.0/src/i',
            'ac_css_path' => 'http://dev2.static.infoedge.com/s/4/113_v5.0.0/src/c',
            'ac_js_path' => 'http://dev2.static.infoedge.com/s/4/113_v5.0.0/src/j',
            'nc2_img_path' => 'http://dev2.static.infoedge.com/s/1/2/i',
            'nc2_css_path' => 'http://dev2.static.infoedge.com/s/1/2/c',
            'nc2_js_path' => 'http://dev2.static.infoedge.com/s/1/2/j',
            'nc0_img_path' => 'http://dev2.static.infoedge.com/s/0/0/src/i',
            'nc0_css_path' => 'http://dev2.static.infoedge.com/s/0/0/src/c',
            'nc0_js_path' => 'http://dev2.static.infoedge.com/s/0/0/src/j',
            'rc_css_path' => 'http://dev2.rstatic.infoedge.com/trunk/web/css',
            'custom.log.handler' => array(
                'level' => 'debug',
                'email' => 'abc@gmail.com',
            ),
            'base_static_url_img' => 'http://dev2.static.infoedge.com',
            'base_static_url_css' => 'http://dev2.static.infoedge.com',
            'base_static_url_js' => 'http://dev2.static.infoedge.com',
            'base_rstatic_url_css' => 'http://dev2.rstatic.infoedge.com/trunk/web/css',
            'base_static_url_s4' => 'http://dev2.static.infoedge.com/s/4',
            'base_static_url_s1' => 'http://dev2.static.infoedge.com/s/1',
            'base_static_url_s0' => 'http://dev2.static.infoedge.com/s/0',
            'ref_share_url' => 'http://dev1.infoedge.com:8000/jobpostingMayank/index.php/referral/vre',
            'asset_min' => '',
            'zendmail' => array(
                'transport' => 'smtp',
                'name' => 'localhost',
            ...
            'security.role_hierarchy.roles' => array(
                'ROLE_ADMIN' => array(
                    0 => 'ROLE_MANAGER',
                    1 => 'ROLE_RECRUITER',
                    2 => 'ROLE_MANAGE_WORKFLOW',
                    3 => 'ROLE_MANAGE_RECRUITERS',
                    4 => 'ROLE_MANAGE_SETTINGS',
                    5 => 'ROLE_DOWNLOAD',
                ),
            ),
            ...
            'twig.exception_listener.controller' => 'NaukriUtilityBundle:NaukriException:show',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => '172.10.122.27:25',
            ...
            'assetic.node.bin' => ($this->targetDirs[5].'/.nvm/versions/node/v11.9.0/bin/node'),
            ...
            'jms_di_extra.bundles' => array(
                0 => 'NaukriJobPostingGatewayBundle',
            ),
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => (__DIR__.'/jms_diextra/doctrine/EntityManager_5ca108e798ecc.php'),
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5ca108e798ecc_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'smarty.class' => 'Smarty',
            'templating.engine.smarty.class' => 'NoiseLabs\\Bundle\\SmartyBundle\\SmartyEngine',
            ...
            'smarty.extension.routing.class' => 'NoiseLabs\\Bundle\\SmartyBundle\\Extension\\RoutingExtension',
            ...
            'smarty.extension.expression.class' => 'NoiseLabs\\Bundle\\SmartyBundle\\Extension\\ExpressionExtension',
            ...
            'smarty.options' => array(
                ...
                'compile_dir' => (__DIR__.'/smarty/templates_c'),
                'config_dir' => ($this->targetDirs[2].'/config/smarty'),
                'default_resource_type' => 'file',
                'plugins_dir' => array(

                ),
                'template_dir' => ($this->targetDirs[2].'/Resources/views'),
                'use_include_path' => false,
                'use_sub_dirs' => true,
            ),
            'smarty.extension.assetic.dynamic.class' => 'NoiseLabs\\Bundle\\SmartyBundle\\Extension\\DynamicAsseticExtension',
            'smarty.extension.assetic.static.class' => 'NoiseLabs\\Bundle\\SmartyBundle\\Extension\\StaticAsseticExtension',
            'smarty.assetic.formula_loader.class' => 'NoiseLabs\\Bundle\\SmartyBundle\\Assetic\\SmartyFormulaLoader',
            'smarty.assetic' => true,
            ...
            'smarty.menu' => false,
            'jpsso.security.authentication.listener.class' => 'Naukri\\JobPostingGatewayBundle\\Util\\Auth\\JPSSOAuthListener',
            'utbundle.smarty.custom.render.class' => 'Naukri\\UtilityBundle\\UtilSmartyExtension\\CustomRenderExtension',
